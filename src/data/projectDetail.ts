    ...
    problemSolving: [
      {
        ...
        problem: `SSR + 데이터 로딩 타이밍 문제로 Swiper가 DOM 크기를 잘못 계산  
첫 진입 시 UI가 깨지는 현상 발생 (새로고침 시 정상)`,
        solution: `**Swiper 의존성 제거**하고, 그룹 단위 슬라이드 및 translateX 기반의 맞춤형 슬라이더를 **직접 구현**`,
...
Next.js 환경에서 안정적으로 동작하는 캐러셀로 개선`,
  ...
  },
  {
    ...
    responsibilities: [
      {
        id: 'res_1',
        title: '1. 사용자 및 사업자 인증 기능',
        items: `
- 카카오/네이버 **OAuth 로그인** 구현
- 사용자 / 사업자 회원가입 및 인증 흐름 구성
`,
      },
      {
        id: 'res_2',
        title: '2. 사업자 전용 서비스 기능',
        items: `
- 사업장 등록 및 룸 추가 기능 구현
    ...
    problemSolving: [
      {
        ...
        solution: `백엔드와 협의하여 Presigned URL 방식을 도입  
